...
import LoadList from "./components/loads/load/LoadList";
import NewDriver from "./components/users/drivers/NewDriver";
import TruckList from './compo'
      ...
      <div>
        <Layout>
          <Routes>
            ...
            <Route path="/load_list" element={<LoadList />} />
            <Route path="/truck_list" element={<TruckList />} />
