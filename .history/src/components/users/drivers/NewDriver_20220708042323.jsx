...
export default function NewDriver({ inputs, title }) {
    ...
    <>
      ...
      {open && (
        <DialogBox
          ...
          content={
            "New driver is just created you can send the credentials and the customer can use these credentials to login"
          }
